...
import { X, Plus, Trash2, Image as ImageIcon, Save, ChevronLeft, ChevronRight, Upload } from 'lucide-react';
        ...
        setSlides([
          {
            ...
            title: 'How We Met',
            text: 'It all started with a chance encounter at a coffee shop...'
          }
        ]);
      }
    }
